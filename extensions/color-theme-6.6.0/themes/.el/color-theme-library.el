...
(defun color-theme-himito ()
  ...
  (color-theme-install
   '(color-theme-himito
      ...
      (mouse-color . "white"))
     (fringe ((t (:background "#000000"))))
     (mode-line ((t (:foreground "#000000" :background "#bababa"))))
     (region ((t (:background "#6d3636"))))
     (font-lock-builtin-face ((t (:foreground "#ffffff"))))
     (font-lock-comment-face ((t (:foreground "#72706e"))))
     (font-lock-function-name-face ((t (:foreground "#d55510"))))
     (font-lock-keyword-face ((t (:foreground "#aaa213"))))
     (font-lock-string-face ((t (:foreground "#2dae30"))))
     (font-lock-type-face ((t (:foreground"#136196"))))
     (font-lock-variable-name-face ((t (:foreground "#ffffff"))))
     (minibuffer-prompt ((t (:foreground "#a6a6a6" :bold t))))
     (font-lock-warning-face ((t (:foreground "Red" :bold t))))
     )))


(defun color-theme-dark-himito ()
  (interactive)
  (color-theme-install
...
(defun color-dark-theme ()
  ...
  (color-theme-install
   '(color-dark-theme
      ...
      (mouse-color . "black"))
     (fringe ((t (:background "#000000"))))
     (mode-line ((t (:foreground "#000000" :background "#E3E3E3"))))
     (region ((t (:background "#3e1e2a"))))
     (font-lock-builtin-face ((t (:foreground "#ffffff"))))
     (font-lock-comment-face ((t (:foreground "#828282"))))
     (font-lock-function-name-face ((t (:foreground "#af893c"))))
     (font-lock-keyword-face ((t (:foreground "#1da5e7"))))
     (font-lock-string-face ((t (:foreground "#32b12b"))))
     (font-lock-type-face ((t (:foreground"#8e932f"))))
     (font-lock-variable-name-face ((t (:foreground "#3b9149"))))
     (minibuffer-prompt ((t (:foreground "#878787" :bold t))))
     (font-lock-warning-face ((t (:foreground "Red" :bold t))))
     )))
(provide 'color-dark-theme)
